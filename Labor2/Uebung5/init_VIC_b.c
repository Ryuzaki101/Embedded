...
VICVectAddr14 = (unsigned long) EXTINT0_Launch_ISR;	// set interrupt vector for buttonpress
	...
	VICVectAddr27 = (unsigned long) Timer3_ISR;	// set interrupt vector for timer
	VICVectPriority27 = 12;										// use VIC Priority for T3IR Interrupt
	VICIntEnable = (1 << 27);									// enable T3IR Interrupt
