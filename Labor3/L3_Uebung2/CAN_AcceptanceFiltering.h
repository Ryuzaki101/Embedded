...
const uint16_t  CAN1_Array_SFF_EXP_IDs[CAN1_Number_SFF_EXP_ID] = {0x100, 0x456, 0x123};
...
const uint16_t  CAN2_Array_SFF_EXP_IDs[CAN2_Number_SFF_EXP_ID] = {0x3DD,0x456, 0x444};
